...
export default function ProjectCard({ link, title, description, className }) {
  return (
    <div
      className={` h-90 lg:h-100 w-fit lg:max-w-88 rounded-2xl col-center justify-center gap-3 md:gap-6  p-1 bg-primary ${className}`}
    >
      <img src="/rough-icons/star.gif" alt="star" className="h-25 sm:h-20" />
