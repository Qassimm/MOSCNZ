  ...
  return (
    <footer className="FOOTER-SECTION ">
      <div className="container relative  flex flex-col md:flex-row items-center gap-2 md:gap-0">
        ...
        <div className="col-center gap-5 z-20">
          ...
          <div className="social-media flex-center gap-5 ">
            {icons.map((icon, i) => (
              ...
              >
                <img src={icon.img} alt={icon.alt} className="h-12 hover:scale-125" />
              </a>
            ))}
          </div>
        ...
        <img src="/background-imgs/blue-bg.png" alt="blue-halftone" className="absolute hidden md:block h-130 lg:h-200 -right-70 opacity-40 " />
        <img src="/background-imgs/yellow-bg.png" alt="yellow-halftone" className="absolute hidden md:block h-200 lg:h-300 -left-50 opacity-70" />

         <a href="#" className="col-center mt-10 group  absolute -bottom-25 right-0 hidden md:block">
        <img src="/arrows/blackArrow.svg" alt="black-arrow" className=" group-hover:-translate-y-5 transition duration-400" />
        <p className="text-5xl text-center font-nerko ">BACK <br /> TO TOP</p>
      </a>
      </div>
